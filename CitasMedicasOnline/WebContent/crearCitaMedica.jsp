...
<title>Generar Cita Medica</title>
<meta charset="utf-8">
                    ...
                    <h2>Generar Cita Medica</h2>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="apellido" name="apellido" required="" placeholder="Escriba la razon de la cita" >
                            </div>
                            <div class="form-group">
                                <label for="nombre">Turno</label>
                                <input type="text" class="form-control" id="direccion" name="direccion" required="" placeholder="6" >
                            </div>
                        </div>
                        <div class="modal-footer">
                        	<button type="submit" >Guardar Cita</button>
                            <button type="button"  data-dismiss="modal">Salir</button>
